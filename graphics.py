...
# Table T
# dots
ax1.scatter(x=x, y=t1_y, label="t1_y", marker='o', c='r', alpha=0.5, s=9)
ax1.scatter(x=x, y=t2_y, label="t2_y", marker='o', c='y', alpha=0.5, s=9)
# lines
ax1.plot(x1, t1_2sk_y, alpha=0.9, label="t1_2", lw=3, mec='y', mew=2, ms=5)
ax1.plot(x1, t1_apr_y, alpha=0.9, label="t1_apr_y", lw=3, mec='c', mew=2, ms=5)
ax1.plot(x1, t2_apr_y, alpha=0.9, label="t2_apr_y", lw=3, mec='m', mew=2, ms=5)
ax1.plot(x1, t2_2_y, alpha=0.9, label="t2_2_y", lw=3, mec='k', mew=2, ms=5)
...
# Table Q
# dots
ax2.scatter(x=x, y=q_y, label="q_y", marker='o', c='r', alpha=0.5, s=9)
# lines
ax2.plot(x1, q_apr_y, alpha=0.9, label="q_apr_y", lw=3, mec='y', mew=2, ms=5)
# Расшифровка линий и точек в графике
ax2.legend()
ax2.grid(True)
# Наименование график, оси Х и У
...
# dots
ax3.scatter(x=x, y=m1_y, label="m1_y", marker='o', c='r', alpha=0.5, s=9)
ax3.scatter(x=x, y=m2_y, label="m2_y", marker='o', c='y', alpha=0.5, s=9)
# Расшифровка линий и точек в графике
ax3.legend()
ax3.grid(True)
# Наименование график, оси Х и У
...
# Table Q/S
# dots
ax4.scatter(x=x, y=q_s_y, label="q_s_y", marker='o', c='r', alpha=0.5, s=9)
# lines
ax4.plot(x, ud_nagr_y, alpha=0.9, label="ud_nagr_y", lw=3, mec='y', mew=2, ms=5)
ax4.plot(x1, q_s_apr_y, alpha=0.9, label="q_s_apr_y", lw=3, mec='k', mew=2, ms=5)
# Расшифровка линий и точек в графике
ax4.legend()
ax4.grid(True)
# Наименование график, оси Х и У
...
# # Table М по дате
# # lines
# ax5.plot(x_date, m1_date_y, alpha=0.9, label="m1_date_y", lw=3, mec='y', mew=2, ms=5)
# ax5.plot(x_date, m2_date_y, alpha=0.9, label="m2_date_y", lw=3, mec='k', mew=2, ms=5)
# # Расшифровка линий и точек в графике
# ax5.legend()
# ax5.grid(True)
# # Наименование график, оси Х и У
